...
const Services = () => {
  return (
    <section className=" bg-[#161616] text-white">
      <div className="max-w-[1440px] flex flex-col justify-center items-center mx-auto my-[8rem] py-[5rem] gap-[4rem] px-[1rem]">
        ...
        <div className="flex items-center justify-center gap-[2rem]">
          ...
          <div className="px-[1.5rem] py-[2.5rem] border border-white">
            <p>2</p>
